...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        public SteamVR_Action_Boolean attachTrigger = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("AttachTrigger");
        public SteamVR_Action_Boolean bindTrigger = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("BindTrigger");
        public SteamVR_Action_Boolean nextTrigger = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("NextTrigger");
        public SteamVR_Action_Boolean previousTrigger = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("PreviousTrigger");
        public SteamVR_Action_Boolean rotationTrigger = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("RotationTrigger");
